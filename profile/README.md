...
- 개발 환경
  - Server: Containerized Node.js, Redis, MySQL stack deployed on AWS Cloud (ECS/Fargate & RDS), CI/CD with AWS CodePipeline
  - Client(Web): React.js with Web 3.0 technologies (NFT, Blockchain) Client(Mobile): Unity with native iOS/watchOS (HealthKit, CoreMotion, CoreML) Machine Learning: PyTorch
- 개발 언어
  - C, C#, Solidity, Swift, Python, Typescript
